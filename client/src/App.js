            ...
            <table>
                ...
                <tbody>
                    {words.map(row => {
                        ...
                        const el = <tr key={row.id} className={!last || last[0] != row.bundle || last[1] != row.class ? 'first' : null}>
                            {!last || last[0] != row.bundle || last[1] != row.class ? <td rowSpan={row.count}>{count}</td> : null}
                            ...
                            {!last || last[0] != row.bundle || last[1] != row.class ? <td className='mean' rowSpan={row.count}>{row.bundle}</td> : null}
                        </tr>
